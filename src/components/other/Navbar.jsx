  ...
  return (
    <div  className='fixed z-50 flex justify-between w-screen ' >
        <div className='p-3  top-0 z-10'>
            <svg xmlns="http://www.w3.org/2000/svg"  width="100" height="44" viewBox="0 0 103 44">
        ...
        <div 
        onMouseEnter={()=>{
            navGreenRef.current.style.opacity = 1
        }}
        onMouseLeave={()=>{
            navGreenRef.current.style.opacity = 0
        }} className='bg-black h-13 relative w-64'>
                <div className='relative' >
                   
                </div>
                <div ref={navGreenRef} className='h-full w-full bg-lime-500 absolute top-0 opacity-0'></div>
        </div>
    </div>
  )
}
